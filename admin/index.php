...
if (isset($_POST['submit'])) {
    ...
    // Prepare statement (PDO for security)
    require_once "php/config.php"; // your DB connection file
...
<head>
    ...
    <title>Admins Login - nomauglobal sub</title>
        ...
        <div class="form-container">
            ...
            <form action="#" method="post" autocomplete="off">
                ...
                <?php if($_SESSION['login_attempt'] >2)
                {
                  ...
                  echo "<p style='color:red; font-size:12px; font-weight:bold;'>your account is locked. Try again after 5 minutes</p>";
                }else{
                ?>
                 <button type="submit" name="submit" id="login-btn">Sign In</button>
        <?php } ?>        
            <div class="signup-link">
                <span>Don't have an account? <a href="php/register.php">Sign up here</a></span>
            </div>
        </div>
    </div>
    <?php if($error) : ?>
        ...
        window.location.href = 'php/aminDashboard.php';
      });
        </script>
        <?php endif; ?>
        <script>
