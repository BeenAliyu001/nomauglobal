...
$txnH_query = $pdo->query("SELECT * FROM transactions WHERE type = 'credit' ORDER BY create_at");
...
<head>
    ...
    <title>All Users  - Payments History</title>
...
<body>
    ...
    <div class="dashboard-container">
            ...
            <ul class="sidebar-menu">
               ...
               <li class="has-submenu" id="transactionMenu">
                    ...
                    <ul class="sub-menu" id="transactionSubMenu">
                        <li><a href="alltxn.php"><i class="fas fa-mobile-alt"></i> All Transactions</a></li>
        ...
        <div class="main-content">
                    ...
                    <h3>Users Wallet Funding History</h3>
                    <table class="transaction-table">
                        ...
                        <tbody>
                           <?php foreach ($txnH as $txn): 
                            ?>
                               <tr>
                                 <td data-label="trans_id"><?php echo htmlspecialchars($txn['transId']); ?></td>
