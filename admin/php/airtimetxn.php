...
$txnH_query = $pdo->query("SELECT trans_id, user_email, type, amount, category, status, api_response, create_at FROM transactions WHERE type = 'airtime' ORDER BY create_at");
            ...
            <ul class="sidebar-menu">
               ...
               <li class="has-submenu" id="transactionMenu">
                    ...
                    <ul class="sub-menu" id="transactionSubMenu">
                      <li><a href="alltxn.php"><i class="fas fa-mobile-alt"></i> All</a></li>
                    ...
                    <table class="transaction-table">
                        ...
                        <tbody>
                           <?php foreach ($txnH as $txn): 
                            ?>
                               <tr>
                                 <td data-label="trans_id"><?php echo htmlspecialchars($txn['trans_id']); ?></td>
                                  <td data-label="type"><?php echo htmlspecialchars($txn['type']); ?></td>
                                   <td data-label="amount"><?php echo htmlspecialchars($txn['amount']); ?></td>
                                   <td data-label="network"><?php echo htmlspecialchars($txn['category']); ?></td>
                                    <td data-label="status"><?php echo htmlspecialchars($txn['status']); ?></td>
                                    <td data-label="date"><?php echo htmlspecialchars($txn['create_at']); ?></td>
                               </tr>
                             <?php endforeach; ?>
                        </tbody>
                    </table>
