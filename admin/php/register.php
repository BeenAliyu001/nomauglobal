...
if(isset($_POST['submit']))
{
  ...
  // try {
    ...
    // preventing the duplicating of an information
   ...
   if(empty($username)) {
    ...
    $error = "Password is required !";
     ...
     $error = "Username or Email already exist !";
      ...
      // preparing user details and insert into database ...
      $stmt = $pdo->prepare("INSERT INTO admins (username, email, phone, password) VALUES(?,?,?,?) ");
      $stmt->execute([$username, $email, $phone, $hashpwd]);
      $users = $stmt;
        if ($users) {
            //message on register success
            $success = "Register success. Redirecting to dashboard ...";
        } else {
            // message on error or failed to register
...
<head>
    ...
    <title>Register - beenaliyusub</title>
        ...
        <div class="form-container">
            ...
            <form action="#" method="post" autocomplete="off">
                ...
                <div class="input-group">
                    ...
                    <div class="input-wrapper">
                        <input type="text" id="email" name="phone" placeholder="Enter your phone number">
                        <div class="input-icon password-toggle" id="password-toggle">
                            <!-- <i class="far fa-telephone-fill"></i> -->
                        </div>
                    </div>
                </div>
                 <div class="input-group">
...
<!--                 
                <div class="footer">
                    <a href="../index.php" class="forgot-password">Already have an account ? Sign In</a>
                </div> -->
            </form>
            ...
            <div style="text-align: center;">
                <button style="background: white; color: #757575; border: 1px solid #ddd; padding: 12px 20px; border-radius: 8px; width: 100%; font-size: 15px; cursor: pointer;">
