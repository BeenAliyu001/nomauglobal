...
// $pft_count_query = $pdo->query("SELECT COUNT(*) as total_pft FROM profits");
// $pft_count = $pft_count_query->fetch(PDO::FETCH_ASSOC)['total_pft'];

// Get all users for the user management table
$users_query = $pdo->query("SELECT id, name, email, phone, BankName, accountName, accountNumber, balance, joinDate FROM users");
$users = $users_query->fetchAll(PDO::FETCH_ASSOC);

// Get all transactions for the user management table
$u_query = $pdo->query("SELECT type, amount, status, create_at FROM transactions");
...
<head>
    ...
    <title>VTU System - Admin Dashboard</title>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar">
           ...
           <ul class="list-unstyled">
                <li><a href="adminDashboard.php"><i class="bi bi-speedometer2"></i> Dashboard</a></li>
                <li><a href="allUsers.php" class="active"><i class="bi bi-people-fill"></i>All Users</a></li>
                <li><a href="transaction.php"><i class="bi bi-wallet2"></i>All Transactions</a></li>
                <li><a href="loginHistory.php"><i class="bi bi-graph-up"></i>Login History</a></li>
                <!-- <li><a href="#"><i class="bi bi-shield-check"></i> Security</a></li> -->
                <li><a href="payments.php"><i class="bi bi-cash-coin"></i> Payments</a></li>
        ...
        <div id="content">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="dropdown ms-3">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="dropdownUser">
                                <li><a class="dropdown-item" href="userProfile.php"><i class="bi bi-person me-2"></i> Profile</a></li>
            ...
            <div class="table-container">
                <div class="table-header">
                    <h2 class="table-title">Registered Users (<?php echo $user_count; ?>)</h2>
                </div>
                    ...
                    <table class="table user-table">
                        ...
                        <tbody>
                            <?php foreach ($users as $user): 
                                $status_class = ($user['balance'] > 0) ? 'status-active' : 'status-inactive';
                                $status_text = ($user['balance'] > 0) ? 'Active' : 'Inactive';
                            ...
                            <tr>
                                ...
                                <td data-label="Bank Details">
                                    <?php if (!empty($user['BankName']) && !empty($user['accountName']) && !empty($user['accountNumber'])): ?>
                                        <div>
                                            <div><?php echo htmlspecialchars($user['BankName']); ?></div>
                                            <div><?php echo htmlspecialchars($user['accountName']); ?></div>
                                            <div><?php echo htmlspecialchars($user['accountNumber']); ?></div>
                                        </div>
                                    <?php else: ?>
                                        <span class="text-muted">Not set</span>
                                    <?php endif; ?>
                                </td>
                                <td data-label="Balance" class="<?php echo $balance_class; ?>">
