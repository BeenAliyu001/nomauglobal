...
$users_query = $pdo->query("SELECT id, username, email, phone, BankName, accountName, accountNumber, balance, joinDate FROM users");
...
<body>
    ...
    <div class="dashboard-container">
            ...
            <ul class="sidebar-menu">
               ...
               <li class="has-submenu" id="transactionMenu">
                    ...
                    <ul class="sub-menu" id="transactionSubMenu">
                        <li><a href="alltxn.php"><i class="fas fa-wifi"></i> All</a></li>
        ...
        <div class="main-content">
                    ...
                    <h3>Total Registered Users (<?php echo $user_count; ?>)</h3>
