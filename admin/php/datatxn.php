...
$txnH_query = $pdo->query("SELECT trans_id, user_email, type, amount, category, status, api_response, create_at FROM transactions WHERE type = 'data' ORDER BY create_at");
